---
title: "<center>
Individual_Project-Summary: Fianl Version to Submit"
author: "<center>
Yinuo (Cathy) Meng"
date: "<center>
2025-03-29"
...
folder <- "/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_FC_genecounts/"

## Reading in featureCounts output
mT5_dfcounts <- read.table(paste0(folder, "mT5-RNAseq_gene_counts_fixed.txt"), header = TRUE)
...
cleaned_names <- gsub(".*\\.mT5_(.+?_S\\d+)\\.marked\\.bam$", "mT5_\\1", orig_names)
...
mT5_coldata$condition <- gsub("^Kras[0-9]+$", "shKras", mT5_coldata$condition)
mT5_coldata$condition <- gsub("^Ren[0-9]*$", "shRenilla", mT5_coldata$condition)
mT5_coldata$condition <- gsub("^Rac1[0-9]*$", "shRac1", mT5_coldata$condition)
```
...
# Output:
                 condition
mT5_Kras242_S117    shKras
mT5_Kras467_S118    shKras
mT5_Rac1_11_S119    shRac1
mT5_Rac1_14_S120    shRac1
mT5_Ren2_S125    shRenilla
mT5_Ren_S116     shRenilla
```
...
mT5_coldata$condition <- relevel(mT5_coldata$condition, ref = "shRenilla")
...
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/library_size_barplot.png", width = 800, height = 600)
...
```{r}
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/library_size_barplot.png")
```
...
# Plotting
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/SF_plot.png", width = 800, height = 600)
...
```{r}
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/SF_plot.png")
```
...
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/Raw_readcounts_mT5.png", width = 800, height = 600)
boxplot(counts(dds_mT5), main = "Read Counts Only", cex = .6)

png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/SFnorm_readcounts_mT5.png", width = 800, height = 600)
...
```{r}
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/Raw_readcounts_mT5.png")
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/SFnorm_readcounts_mT5.png")
```
...
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/Non-norm_barplot_mT5.png", width = 800, height = 600)
...
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/SF-norm_barplot_mT5.png", width = 800, height = 600)
...
```{r}
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/Non-norm_barplot_mT5.png")
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/SF-norm_barplot_mT5.png")
```
...
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/shKras_cor_mT5.png", width = 800, height = 600)
dds_mT5[, c("mT5_Kras242_S117","mT5_Kras467_S118")] %>% 
  assay(., "log_norm_counts") %>%
  plot(., cex=.1, main = "shKras242 vs. shKras467")
dev.off()

png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/shRac1_cor_mT5.png", width = 800, height = 600)
dds_mT5[, c("mT5_Rac1_11_S119","mT5_Rac1_14_S120")] %>% 
  assay(., "log_norm_counts") %>%
  plot(., cex=.1, main = "shRac1_11 vs. shRac1_14")
dev.off()

png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/shRenilla_cor_mT5.png", width = 800, height = 600)
dds_mT5[, c("mT5_Ren2_S125","mT5_Ren_S116")] %>% 
  assay(., "log_norm_counts") %>%
  plot(., cex=.1, main = "shRenilla2 vs. shRenilla")
dev.off()
```

Output of correlation plots for all 3 conditions:
```{r}
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/shKras_cor_mT5.png")
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/shRac1_cor_mT5.png")
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/shRenilla_cor_mT5.png")
```
...
# Plotting
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/msdplot_mT5.png", width = 800, height = 600)
...
Output msd plot:  
```{r}
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/msdplot_mT5.png")
```
...
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/SF-log2-transform_mT5.png", width = 800, height = 600)
...
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/rlog-transform_mT5.png", width = 800, height = 600)
...
Output plots:  
```{r}
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/SF-log2-transform_mT5.png")
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/rlog-transform_mT5.png")
```
  
**Interpretation:  The variance is much lower for small read counts using rlog transformation.**    

```{r, eval=FALSE}
rlog_norm_counts <- assay(ddsmT5_dst_rlog)
```


```{r, eval=FALSE}
# To visualize the above interpretation: draw mean-sd-plot
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/rlog_msdplot_mT5.png", width = 800, height = 600)
...
Output plot:  
```{r}
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/rlog_msdplot_mT5.png")
```
...
```{r, eval=FALSE}
save.image(file = "/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_images/DESeqAnalysis_mT5_ReadingIntoR.RData")
```
  
  
  
#### Part IX: Exploratory data analysis plots    
...
# Use rlog-normalized counts to compute correlations and then sample-sample distances, plotting the result as a heatmap
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DEseq_ExploratoryAnalysis_images/PearsonCor_mT5.png", width = 800, height = 600)
...
Output heatmap:  
```{r}
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DEseq_ExploratoryAnalysis_images/PearsonCor_mT5.png")
```
  
**Interpretation: **
```
There are some differences between the two biological replicates of each of the 3 conditions (shKras, shRac1, shRenilla, each of which representing the target of our shRNA construct in the cell line model), which might be due to biological variations between samples. However, as expected, there seems to be very huge difference across the 3 experimental conditions, indicting strong and good separation between our conditions.
```
...
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DEseq_ExploratoryAnalysis_images/Dendrogram_mT5.png", width = 800, height = 600)
...
Output dendrogram:  
```{r}
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DEseq_ExploratoryAnalysis_images/Dendrogram_mT5.png")
```
  
**Interpretation: **
```
The dendrogram plot confirms what has been observed from heatmap.
```
  
  
*C. PCA*  
```{r, eval=FALSE}
# Manual computation of PCA analysis
rv <- matrixStats::rowVars(as.matrix(rlog_norm_counts), useNames = TRUE)
...
mT5_Kras242_S117  -5.79821169   8.622172   2.177493 -7.4922253 -0.98844336 1.314227e-14
mT5_Kras467_S118 -23.09305419  11.149662  -3.173001  4.0973642  0.01402502 1.055406e-14
mT5_Rac1_11_S119  15.30660337  10.503979  11.893241  2.7590851  0.29441477 3.774758e-15
mT5_Rac1_14_S120  17.60619732   4.750638 -13.461516  0.2685765  0.20896620 1.594905e-14
mT5_Ren2_S125     -0.08125628 -19.425117   1.143886  1.4680356 -3.04141682 3.358425e-15
mT5_Ren_S116      -3.94027853 -15.601335   1.419896 -1.1008361  3.51245418 5.093148e-15
```

```{r, eval=FALSE}
# PCA plotting
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_ExploratoryAnalysis_images/PCA_mT5.png", width = 800, height = 600)

plotPCA(ddsmT5_dst_rlog) +
  labs(color=NULL) +
  theme_bw()
...
Output PCA:  
```{r}
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_ExploratoryAnalysis_images/PCA_mT5.png")
```

**Interpretation: **
```
The PCA plot further confirms what has been observed from heatmap. In addition, the PCA plot might also demonstrate a slightly larger difference between the two biological replicates of "Kras" condition than the difference between replicates of the otehr two conditions.
```

#### Part X: Differential Gene Expression Analysis    
  
  
*A. Running DESeq analysis*    
```{r, eval=FALSE}
library(DESeq2)
library(tidyverse)
library(magrittr)
...
dim: 20444 6 
metadata(1): version
assays(6): counts log_counts ... H cooks
rownames(20444): Zc3h14 Troap ... Gm5565 Paqr9
rowData names(38): Geneid Chr ... deviance maxCooks
colnames(6): mT5_Kras242_S117 mT5_Kras467_S118 ... mT5_Ren2_S125 mT5_Ren_S116
...
# It seems that results() by default compares the first non-reference level to the reference level (which is "Ren"), I need to defined the comparison manually:  
ddsmT5_shKras_vs_shRen <- results(dds_mT5, contrast = c("condition", "shKras", "shRenilla"), independentFiltering = TRUE, alpha = 0.05)

ddsmT5_shKras_vs_shRac1 <- results(dds_mT5, contrast = c("condition", "shKras", "shRac1"), independentFiltering = TRUE, alpha = 0.05)

ddsmT5_shRac1_vs_shRen <- results(dds_mT5, contrast = c("condition", "shRac1", "shRenilla"), independentFiltering = TRUE, alpha = 0.05)

# Check on which comparison was done to achieve the log2FC
head(ddsmT5_shKras_vs_shRen)
head(ddsmT5_shKras_vs_shRac1)
head(ddsmT5_shRac1_vs_shRen)
```
...
# Output: 
log2 fold change (MLE): condition shKras vs shRenilla 
Wald test p-value: condition shKras vs shRenilla 
DataFrame with 6 rows and 6 columns
                 baseMean log2FoldChange     lfcSE      stat      pvalue        padj
                <numeric>      <numeric> <numeric> <numeric>   <numeric>   <numeric>
Zc3h14         15644.0130      0.0272675  0.101287  0.269209 7.87768e-01 8.86182e-01
Troap           1144.9131     -1.5978899  0.195211 -8.185429 2.71335e-16 5.32054e-14
Clca2             13.2089      1.3218255  1.162921  1.136642 2.55688e-01 4.51686e-01
X1810013L24Rik  3601.0808      0.4841048  0.127001  3.811820 1.37948e-04 1.41437e-03
Srsf7          27798.6864      0.2699746  0.154639  1.745837 8.08393e-02 2.04273e-01
Fignl2           875.4660      0.3110071  0.256024  1.214759 2.24458e-01 4.14244e-01
```
...
# Output: 
log2 fold change (MLE): condition shKras vs shRac1 
Wald test p-value: condition shKras vs shRac1 
DataFrame with 6 rows and 6 columns
                 baseMean log2FoldChange     lfcSE      stat    pvalue      padj
                <numeric>      <numeric> <numeric> <numeric> <numeric> <numeric>
Zc3h14         15644.0130      0.0968488  0.101365  0.955449 0.3393506  0.607555
Troap           1144.9131     -0.4349156  0.197217 -2.205265 0.0274355  0.136629
Clca2             13.2089      1.6655177  1.184751  1.405796 0.1597848  0.400607
X1810013L24Rik  3601.0808     -0.2502860  0.126653 -1.976149 0.0481379  0.196406
Srsf7          27798.6864     -0.1469858  0.154629 -0.950572 0.3418219  0.610446
Fignl2           875.4660      0.2592109  0.256403  1.010951 0.3120397  0.581834
```
...
# Output: 
log2 fold change (MLE): condition shRac1 vs shRenilla 
Wald test p-value: condition shRac1 vs shRenilla 
DataFrame with 6 rows and 6 columns
                 baseMean log2FoldChange     lfcSE      stat      pvalue        padj
                <numeric>      <numeric> <numeric> <numeric>   <numeric>   <numeric>
Zc3h14         15644.0130     -0.0695813  0.101272 -0.687074 4.92036e-01 6.76782e-01
Troap           1144.9131     -1.1629742  0.193579 -6.007752 1.88113e-09 6.76798e-08
Clca2             13.2089     -0.3436923  1.202820 -0.285739 7.75078e-01 8.77130e-01
X1810013L24Rik  3601.0808      0.7343908  0.126687  5.796898 6.75527e-09 2.13630e-07
Srsf7          27798.6864      0.4169604  0.154613  2.696799 7.00094e-03 3.15042e-02
Fignl2           875.4660      0.0517963  0.256192  0.202178 8.39778e-01 9.17379e-01
```

```{r, eval=FALSE}
# Combine DESeq2 results across comparisons into a single table:
library(dplyr)

# Convert results to data.frames and add gene names
res_shRac1_vs_shRen_df <- as.data.frame(ddsmT5_shRac1_vs_shRen)
res_shKras_vs_shRen_df <- as.data.frame(ddsmT5_shKras_vs_shRen)
res_shKras_vs_shRac1_df <- as.data.frame(ddsmT5_shKras_vs_shRac1)

res_shRac1_vs_shRen_df$gene <- rownames(res_shRac1_vs_shRen_df)
res_shKras_vs_shRen_df$gene <- rownames(res_shKras_vs_shRen_df)
res_shKras_vs_shRac1_df$gene <- rownames(res_shKras_vs_shRac1_df)

# Merge all comparisons by gene
combined_res <- res_shRac1_vs_shRen_df %>%
  dplyr::rename_with(~paste0(., "_shRac1_vs_shRenilla"), -gene) %>%
  left_join(
    res_shKras_vs_shRen_df %>%
      dplyr::select(-baseMean, -lfcSE, -stat, -pvalue) %>%
      dplyr::rename_with(~paste0(., "_shKras_vs_shRenilla"), -gene),
    by = c("gene" = "gene")
  ) %>%
  left_join(
    res_shKras_vs_shRac1_df %>%
      dplyr::select(-baseMean, -lfcSE, -stat, -pvalue) %>%
      dplyr::rename_with(~paste0(., "_shKras_vs_shRac1"), -gene),
    by = c("gene" = "gene")
  )

rownames(combined_res) <- combined_res$gene
combined_res$gene <- NULL
```
...
# Output:
               baseMean_shRac1_vs_shRenilla log2FoldChange_shRac1_vs_shRenilla lfcSE_shRac1_vs_shRenilla
Zc3h14                          15644.01302                        -0.06958130                 0.1012719
Troap                            1144.91307                        -1.16297424                 0.1935789
Clca2                              13.20891                        -0.34369227                 1.2028205
X1810013L24Rik                   3601.08077                         0.73439084                 0.1266869
Srsf7                           27798.68641                         0.41696035                 0.1546130
Fignl2                            875.46603                         0.05179627                 0.2561917
               stat_shRac1_vs_shRenilla pvalue_shRac1_vs_shRenilla padj_shRac1_vs_shRenilla
Zc3h14                       -0.6870742               4.920360e-01             6.767823e-01
Troap                        -6.0077522               1.881130e-09             6.767980e-08
Clca2                        -0.2857386               7.750783e-01             8.771305e-01
X1810013L24Rik                5.7968981               6.755271e-09             2.136301e-07
Srsf7                         2.6967994               7.000943e-03             3.150425e-02
Fignl2                        0.2021778               8.397777e-01             9.173793e-01
               log2FoldChange_shKras_vs_shRenilla padj_shKras_vs_shRenilla log2FoldChange_shKras_vs_shRac1
Zc3h14                                 0.02726752             8.861821e-01                      0.09684882
Troap                                 -1.59788986             5.320539e-14                     -0.43491562
Clca2                                  1.32182548             4.516863e-01                      1.66551775
X1810013L24Rik                         0.48410483             1.414368e-03                     -0.25028601
Srsf7                                  0.26997459             2.042730e-01                     -0.14698576
Fignl2                                 0.31100713             4.142441e-01                      0.25921087
               padj_shKras_vs_shRac1
Zc3h14                     0.6075546
Troap                      0.1366287
Clca2                      0.4006074
X1810013L24Rik             0.1964058
Srsf7                      0.6104462
Fignl2                     0.5818336
```
  
  
*B. Visualizing assessments using normalized gene counts*     
  
*Visualization by Histogram of adjusted p-values*    
```{r, eval=FALSE}
# Generate Histogram of padj for 'Rac1_vs_Ren' condition:  

png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/Histogram_shRac1_vs_shRenilla.png", width = 800, height = 600)

res_shRac1_vs_shRen_df$padj %>% hist(breaks=19, main="Adjusted p-values for shRac1 vs shRenilla", ylim = c(0, 5000))

dev.off()

# Generate Histogram of padj for 'Kras_vs_Ren' condition:  

png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/Histogram_shKras_vs_shRenilla.png", width = 800, height = 600)

res_shKras_vs_shRen_df$padj %>% hist(breaks=19, main="Adjusted p-values for shKras vs shRenilla", ylim = c(0, 5000))

dev.off()

# Generate Histogram of padj for 'Kras_vs_Rac1' condition:  

png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/Histogram_shKras_vs_shRac1.png", width = 800, height = 600)

res_shKras_vs_shRac1_df$padj %>% hist(breaks=19, main="Adjusted p-values for shKras vs shRac1", ylim = c(0, 2000))
...
```{r}
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/Histogram_shRac1_vs_shRenilla.png")

knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/Histogram_shKras_vs_shRenilla.png")

knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/Histogram_shKras_vs_shRac1.png")
```
  
**Interpretation: **
```
From the histograms of p-values: the results meet reasonable expectations in terms of the number of genes passing the adj. p-value (<0.05) threshold. "shRenilla", the shRenilla knock-down condition in my mouse PDAC cancer cell line (mT5), is our negative control, whereas "shRac1", the shRac1 knock-down condition, and "shKras", the shKras knock-down condition in the same cell line, are the experimental condition and positive control respectively. According to what is expected, the "shRac1" condition and "shKras" condition will result in significant gene expression alterations from the negative control "shRenilla", while "shRac1" condition will more recapitulate the result pattern from "shKras" condition. This is confirmed from the histograms of p-values analysis, where less significantly differentially expressed genes (padj < 0.05) and more non-significantly differentially expressed genes (padj > or = 0.05) are observed in "shKras_vs_shRac1" comparison over "shRac1_vs_shRenilla" and "shKras_vs_shRenilla" comparisons.
```
  
  
*C. Visualizing DESeq analysis via Heatmap.*    
  
*First perform Heatmap visualization on the 3 condition-combined dataset:*    
```{r, eval=FALSE}
# Generate heatmap of the genes that shows differential expression with adjusted p-value <0.05
library(pheatmap)
library(DESeq2)

# Sort padj values of the combined_res_new data matrix in order of the "Rac1_vs_Ren" condition
combined_res_sorted <- combined_res %>% arrange(padj_shRac1_vs_shRenilla)

# Identify genes with the desired adjusted p-value cut-off
genes_dge <- rownames(subset(combined_res_sorted, padj_shRac1_vs_shRenilla < 0.05))

# Extract rlog-transformed values into a matrix
rlog_dge <- ddsmT5_dst_rlog[genes_dge,] %>% assay

# Heatmap of DEG sorted by adjusted p-value (no scaling)
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/Heatmap_no_scaling.png", width = 800, height = 600)
...
# Heatmap of DEG sorted by adjusted p-value (Z-score centered scaling)
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/Heatmap_Zscore.png", width = 800, height = 600)
...
Output of the Heatmaps:  
```{r}
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/Heatmap_no_scaling.png")

knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/Heatmap_Zscore.png")
```
  
  
*Then perform Heatmap visualization on the 'Rac1 Vs Ren' and 'Krac Vs Ren' condition dataset separately:*    
```{r, eval=FALSE}
# Generate heatmap of the genes that shows differential expression with adjusted p-value <0.05

# Sort padj values of the 'res_shRac1_vs_shRen_df' data matrix in order of the "shRac1_vs_shRen" condition, and sort padg values of the 'res_shKras_vs_shRen_df' data matrix in order of the "shKras_vs_shRen" condition
res_shRac1_vs_shRen_df_sorted <- res_shRac1_vs_shRen_df %>% arrange(padj)
res_shKras_vs_shRen_df_sorted <- res_shKras_vs_shRen_df %>% arrange(padj)

# Identify genes with the desired adjusted p-value cut-off
genes_dge_shRac1_vs_shRen <- rownames(subset(res_shRac1_vs_shRen_df_sorted, padj < 0.05))
genes_dge_shKras_vs_shRen <- rownames(subset(res_shKras_vs_shRen_df_sorted, padj < 0.05))

# Before extrating rlog-transformed values from my DESeq dataset:
# Subset sample names from colData(dds) for shRac1 vs shRen and Subset sample names for shKras vs shRen
samples_shRac1_shRen <- colnames(ddsmT5_dst_rlog)[colData(ddsmT5_dst_rlog)$condition %in% c("shRac1", "shRenilla")]
samples_shKras_shRen <- colnames(ddsmT5_dst_rlog)[colData(ddsmT5_dst_rlog)$condition %in% c("shKras", "shRenilla")]

# Extract rlog-transformed values: subset rlog matrix to only selected DEGs and relevant samples
rlog_dge_shRac1_vs_shRen <- assay(ddsmT5_dst_rlog)[genes_dge_shRac1_vs_shRen, samples_shRac1_shRen]
rlog_dge_shKras_vs_shRen <- assay(ddsmT5_dst_rlog)[genes_dge_shKras_vs_shRen, samples_shKras_shRen]

# Heatmap of DEG sorted by adjusted p-value (no scaling)
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/shRac1_vs_shRen_Heatmap_no_scaling.png", width = 800, height = 600)

pheatmap(rlog_dge_shRac1_vs_shRen, scale="none",
         show_rownames=FALSE, main="shRac1 VS shRenilla: DGE (no scaling)",
         color=colorRampPalette(RColorBrewer::brewer.pal(n=7, name="Reds"))(100)
         )
dev.off()

png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/shKras_vs_shRen_Heatmap_no_scaling.png", width = 800, height = 600)

pheatmap(rlog_dge_shKras_vs_shRen, scale="none",
         show_rownames=FALSE, main="shKras VS shRenilla: DGE (no scaling)",
         color=colorRampPalette(RColorBrewer::brewer.pal(n=7, name="Reds"))(100)
         )
dev.off()
...
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/shRac1_vs_shRen_Heatmap_Zscore.png", width = 800, height = 600)

pheatmap(rlog_dge_shRac1_vs_shRen, 
         scale="row", 
         show_rownames=FALSE, 
         main="shRac1 VS shRenilla: DGE (row-based z-score)")

dev.off()

png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/shKras_vs_shRen_Heatmap_Zscore.png", width = 800, height = 600)

pheatmap(rlog_dge_shKras_vs_shRen, 
         scale="row", 
         show_rownames=FALSE, 
         main="shKras VS shRenilla: DGE (row-based z-score)")
...
Output of the Heatmaps:  
```{r}
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/shRac1_vs_shRen_Heatmap_no_scaling.png")

knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/shKras_vs_shRen_Heatmap_no_scaling.png")

knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/shRac1_vs_shRen_Heatmap_Zscore.png")

knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/shKras_vs_shRen_Heatmap_Zscore.png")
```
  
  
*D. Visualizing genes that are statistically significantly differentially expressed in our experimental group 'shRac1' (shRac1 knock-down)/postivie control group 'shKras' (shKras knock-down) versus the negative control 'shRenilla'(shRenilla knock-down), to identify the most significantly altered genetic function associated with shRac1 in comparison with shKras.*      
```{r, eval=FALSE}
# BiocManager::install("EnhancedVolcano")
library(EnhancedVolcano)

# Generate volcano plot with log2FC for Rac1 V.S. Ren conidtion:
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_Volcano_shRac1_VS_shRenilla.png", width = 1000, height = 1000, res = 150)
EnhancedVolcano(res_shRac1_vs_shRen_df,
                lab=rownames(res_shRac1_vs_shRen_df),
                x='log2FoldChange', y='padj',
                pCutoff=0.05,
                title="shRac1 / shRenilla")
dev.off()

# Generate volcano plot with log2FC for Kras V.S. Ren conidtion:
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_Volcano_shKras_VS_shRenilla.png", width = 1000, height = 1000, res = 150)
EnhancedVolcano(res_shKras_vs_shRen_df,
                lab=rownames(res_shKras_vs_shRen_df),
                x='log2FoldChange', y='padj',
                pCutoff=0.05,
                title="shKras / shRenilla")
dev.off()

```

Output of the Volcano Plots:  
```{r}
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_Volcano_shRac1_VS_shRenilla.png")

knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_Volcano_shKras_VS_shRenilla.png")
```

  
    
*E. Continued Visualization--Shrink logFC estimates of the 'dds_mT5_new' DESeq object for lowly and noisily expressed genes towards zero in order to reduce their importance for any analysis and repeat the above visualization analysis.*      
...
# Check on the coefficient name to be used for logFC shrinkage by resultsNames(), give me an output of '[1] "Intercept" "condition_shKras_vs_shRenilla" "condition_shRac1_vs_shRenilla"', which suggests that I can perform logFC shrinkage to "condition_Kras_vs_Ren" "condition_Rac1_vs_Ren" comparisons:


# Run logFC shrinkage to 'Rac1 to Ren' comparison, and 'Kras to Ren' comparison condition separately:
res_shRac1_vs_shRen_df_shrunk <- lfcShrink(dds_mT5,
                                       coef = "condition_shRac1_vs_shRenilla",
                                       type="apeglm")

res_shKras_vs_shRen_df_shrunk <- lfcShrink(dds_mT5,
                                       coef = "condition_shKras_vs_shRenilla",
                                       type="apeglm")

# Check on the dataset
res_shRac1_vs_shRen_df_shrunk
res_shKras_vs_shRen_df_shrunk
```
  
Output on the dataset check:
```{}
# For res_rac1_vs_ren_df_shrunk dataset: 

log2 fold change (MAP): condition shRac1 vs shRenilla 
Wald test p-value: condition shRac1 vs shRenilla 
DataFrame with 20444 rows and 5 columns
                  baseMean log2FoldChange     lfcSE      pvalue        padj
                 <numeric>      <numeric> <numeric>   <numeric>   <numeric>
Zc3h14          15644.0130     -0.0742092 0.0977335 4.92036e-01 6.81003e-01
Troap            1144.9131     -1.1073655 0.1966266 1.88113e-09 6.94791e-08
Clca2              13.2089     -0.0300175 0.3577085 7.75078e-01 8.79469e-01
X1810013L24Rik   3601.0808      0.7058906 0.1274242 6.75527e-09 2.19310e-07
Srsf7           27798.6864      0.3680294 0.1514588 7.00094e-03 3.23125e-02
...                    ...            ...       ...         ...         ...
Speer4f2         10.850985      -0.135984  0.405983   0.0280114   0.0946150
Thoc2l         6699.597707      -0.151889  0.120054   0.1797981   0.3573295
Gm42517           1.952374      -0.021016  0.371605   0.6287429          NA
Gm5565            0.284878      -0.015463  0.373069   0.6540527          NA
Paqr9            54.223168      -1.053489  0.689688   0.0068266   0.0316896
```

```{}
# For res_kras_vs_ren_df_shrunk dataset:

log2 fold change (MAP): condition shKras vs shRenilla 
Wald test p-value: condition shKras vs shRenilla 
DataFrame with 20444 rows and 5 columns
                  baseMean log2FoldChange     lfcSE      pvalue        padj
                 <numeric>      <numeric> <numeric>   <numeric>   <numeric>
Zc3h14          15644.0130      0.0313539 0.0976883 7.87768e-01 8.86182e-01
Troap            1144.9131     -1.5532095 0.1974770 2.71335e-16 5.32054e-14
Clca2              13.2089      0.1204273 0.3761124 2.55688e-01 4.51686e-01
X1810013L24Rik   3601.0808      0.4534546 0.1264411 1.37948e-04 1.41437e-03
Srsf7           27798.6864      0.2381284 0.1477458 8.08393e-02 2.04273e-01
...                    ...            ...       ...         ...         ...
Speer4f2         10.850985    0.125364292  0.389943   0.0956159    0.230474
Thoc2l         6699.597707    0.201248727  0.120674   0.0759710    0.195114
Gm42517           1.952374   -0.000413766  0.361498   0.9852814          NA
Gm5565            0.284878   -0.014398937  0.364169   0.6806221          NA
Paqr9            54.223168    0.031574173  0.304903   0.8545067    0.925096
```
  
  
*Visualizing genes that are statistically significantly differentially expressed in our experimental group 'Rac1' (shRac1 knock-down)/postivie control group 'Kras' (shKras knock-down) versus the negative control 'Ren'(shRenilla knock-down), with the logFC shrunk datasets.*      
```{r, eval=FALSE}
# BiocManager::install("EnhancedVolcano")
library(EnhancedVolcano)

# Generate volcano plot with log2FC for shRac1 V.S. shRenilla conidtion:
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_Volcano_shRac1_VS_shRenilla_shrunk.png", width = 1000, height = 1000, res = 150)
EnhancedVolcano(res_shRac1_vs_shRen_df_shrunk,
                lab=rownames(res_shRac1_vs_shRen_df_shrunk),
                x='log2FoldChange', y='padj',
                pCutoff=0.05,
                title="with logFC Shrinkage: shRac1 / shRenilla")
dev.off()

# Generate volcano plot with log2FC for shKras V.S. shRenilla condition:
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_Volcano_shKras_VS_shRenilla_shrunk.png", width = 1000, height = 1000, res = 150)
EnhancedVolcano(res_shKras_vs_shRen_df_shrunk,
                lab=rownames(res_shKras_vs_shRen_df_shrunk),
                x='log2FoldChange', y='padj',
                pCutoff=0.05,
                title="with logFC Shrinkage: shKras / shRenilla")
dev.off()
...
Output of the Volcano Plots:  
```{r}
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_Volcano_shRac1_VS_shRenilla_shrunk.png")

knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_Volcano_shKras_VS_shRenilla_shrunk.png")
```
  
   
    
*F. Perform Gene Set Enrichment Analysis (GSEA) to identify biological pathways or functional categories that demonstrate coordinated, statistically significant expression changes with shRac1 KD: *   
*Continue with GSEA analysis using logFC shrunk dataset*  
```{r, eval=FALSE}
# Load packages
...
# Experimental group is shRac1 KD so that I will focus on the 'Rac1' condition and perform GSEA on 'shRac1 Vs shRenilla' comparison
# Remove genes with missing log2FC
GSEA_df_shRac1_vs_shRen <- res_shRac1_vs_shRen_df_shrunk[!is.na(res_shRac1_vs_shRen_df$log2FoldChange), ]

# Map mouse gene SYMBOLS to Entrez IDs
GSEA_df_shRac1_vs_shRen$entrez <- mapIds(org.Mm.eg.db,
                                         keys = rownames(GSEA_df_shRac1_vs_shRen),
                                         column = "ENTREZID",
                                         keytype = "SYMBOL",
                                         multiVals = "first")

# Drop rows without Entrez IDs
GSEA_df_shRac1_vs_shRen <- GSEA_df_shRac1_vs_shRen[!is.na(GSEA_df_shRac1_vs_shRen$entrez), ]

# Create a named numeric vector for GSEA
gene_list <- GSEA_df_shRac1_vs_shRen$log2FoldChange
names(gene_list) <- GSEA_df_shRac1_vs_shRen$entrez
gene_list <- sort(gene_list, decreasing = TRUE)

# Run GSEA for the 3 branches of the Gene Ontology (GO) correspondingly:
GSEA_mT5_shRac1_vs_shRen_BP <- gseGO(geneList = gene_list,
                                     OrgDb = org.Mm.eg.db,
                                     keyType = "ENTREZID",
                                     ont = "BP",                  
                                     minGSSize = 10,
...
GSEA_mT5_shRac1_vs_shRen_MF <- gseGO(geneList = gene_list,
                                     OrgDb = org.Mm.eg.db,
                                     keyType = "ENTREZID",
                                     ont = "MF",                  
                                     minGSSize = 10,
...
GSEA_mT5_shRac1_vs_shRen_CC <- gseGO(geneList = gene_list,
                                     OrgDb = org.Mm.eg.db,
                                     keyType = "ENTREZID",
                                     ont = "CC",                  
                                     minGSSize = 10,
...
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_dotplot_shRac1_VS_shRenilla_BP.png", width = 800, height = 600, res = 150)
dotplot(GSEA_mT5_shRac1_vs_shRen_BP, 
        showCategory = 20, 
        title = "GSEA - GO BP (Mouse)") +
  scale_size(range = c(2, 4)) +
  theme(axis.text.y = element_text(size = 6))
dev.off()

png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_dotplot_shRac1_VS_shRenilla_MF.png", width = 800, height = 600, res = 150)
dotplot(GSEA_mT5_shRac1_vs_shRen_MF, 
        showCategory = 20, 
        title = "GSEA - GO MF (Mouse)") + 
  scale_size(range = c(2, 4)) +
  theme(axis.text.y = element_text(size = 6))
dev.off()

png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_dotplot_shRac1_VS_shRenilla_CC.png", width = 800, height = 600, res = 150)
dotplot(GSEA_mT5_shRac1_vs_shRen_CC, 
        showCategory = 20, 
        title = "GSEA - GO CC (Mouse)") +
  scale_size(range = c(2, 4)) +
  theme(axis.text.y = element_text(size = 6))
dev.off()

# GSEA plot for a specific term:
# GSEA plot for cell growth and proliferation:
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_shRac1_VS_shRenilla_Growth.png", width = 800, height = 600, res = 150)
gseaplot2(GSEA_mT5_shRac1_vs_shRen_BP,
          geneSetID = "GO:0016049",
          title = "Cell growth")
dev.off()

png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_shRac1_VS_shRenilla_Proliferation.png", width = 800, height = 600, res = 150)
gseaplot2(GSEA_mT5_shRac1_vs_shRen_BP,
          geneSetID = "GO:0008283",
          title = "Cell population proliferation")
dev.off()

# GSEA plot for Senescence:
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_shRac1_VS_shRenilla_CellSenescence.png", width = 800, height = 600, res = 150)
gseaplot2(GSEA_mT5_shRac1_vs_shRen_BP,
          geneSetID = "GO:0090398",
          title = "Cellular Senescence")
dev.off()

png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_shRac1_VS_shRenilla_RepSenescence.png", width = 800, height = 600, res = 150)
gseaplot2(GSEA_mT5_shRac1_vs_shRen_BP,
          geneSetID = "GO:0090399",
          title = "Replicative Senescence")
dev.off()

png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_shRac1_VS_shRenilla_SenescenceReg.png", width = 800, height = 600, res = 150)
gseaplot2(GSEA_mT5_shRac1_vs_shRen_BP,
          geneSetID = "GO:2000773",
          title = "Regulation of Cellular Senescence")
dev.off()

png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_shRac1_VS_shRenilla_PreMSenescence.png", width = 800, height = 600, res = 150)
gseaplot2(GSEA_mT5_shRac1_vs_shRen_BP,
          geneSetID = "GO:0090400",
          title = "Stress-induced Premature Senescence")
dev.off()

# GSEA plot for cell migration:
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_shRac1_VS_shRenilla_Migration.png", width = 800, height = 600, res = 150)
gseaplot2(GSEA_mT5_shRac1_vs_shRen_BP,
          geneSetID = "GO:0016477",
          title = "Cell migration")
dev.off()

png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_shRac1_VS_shRenilla_Motility.png", width = 800, height = 600, res = 150)
gseaplot2(GSEA_mT5_shRac1_vs_shRen_BP,
          geneSetID = "GO:0048870",
          title = "Cell motility")
dev.off()

# GSEA plot for EMT:
png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_shRac1_VS_shRenilla_EMT.png", width = 800, height = 600, res = 150)
gseaplot2(GSEA_mT5_shRac1_vs_shRen_BP,
          geneSetID = "GO:0001837",
          title = "Epithelial to Mesenchymal Transition")
dev.off()

png("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_shRac1_VS_shRenilla_EMTReg.png", width = 800, height = 600, res = 150)
gseaplot2(GSEA_mT5_shRac1_vs_shRen_BP,
          geneSetID = "GO:0010717",
          title = "Regulation of epithelial to mesenchymal transition")
dev.off()
```
...
Output: 
```{r}
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_dotplot_shRac1_VS_shRenilla_BP.png")
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_dotplot_shRac1_VS_shRenilla_MF.png")
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_dotplot_shRac1_VS_shRenilla_CC.png")

knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_shRac1_VS_shRenilla_Growth.png")
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_shRac1_VS_shRenilla_Proliferation.png")
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_shRac1_VS_shRenilla_CellSenescence.png")
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_shRac1_VS_shRenilla_RepSenescence.png")
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_shRac1_VS_shRenilla_SenescenceReg.png")
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_shRac1_VS_shRenilla_PreMSenescence.png")
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_shRac1_VS_shRenilla_Migration.png")
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_shRac1_VS_shRenilla_Motility.png")
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_shRac1_VS_shRenilla_EMT.png")
knitr::include_graphics("/Users/yinuomeng/Desktop/Next_Gen_Seq/Individual_Project/Project_file_summary/New_DESeq_Visualization_images/mT5_GSEA_shRac1_VS_shRenilla_EMTReg.png")
```
